 ...
 *     <li>改造项6：下载倍速字段（a=downloadspeed:，首字母大写）</li>
...
public final class SdpFieldHelper {
    ...
    /**
     * SDP s 字段中标识下载场景的固定值
     * <p>改造项4：来源 2022版 9.2.2，s 字段取值固定为 "DoWnload"（W大写，其余小写）</p>
     */
     ...
     * 在 SDP 中追加下载场景的 s 字段
     * <p>
     * 改造项4：下载场景下 s 字段使用 "DoWnload"（W大写，其余小写）。
    ...
    // ================================================================
    // 改造项6：下载倍速字段（a=downloadspeed:，首字母大写）
    // ================================================================

    /**
     * 在 SDP 中追加下载倍速字段
     * <p>
     * 改造项6：下载倍速字段名为 a=downloadspeed:，首字母大写。
    ...
    public static void appendDownloadSpeed(StringBuilder sdpBuilder, double speed) {
        ...
        // 改造项6：固定字段名 downloadspeed，首字母大写
